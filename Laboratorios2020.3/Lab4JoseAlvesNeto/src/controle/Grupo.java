...
public class Grupo {
	 ...
	 */
	public boolean alocarAluno(RepAluno repAluno, String matricula) {
		if (repAluno.getAluno(matricula) == null) {
			return false;
		} else if (alunos.contains(repAluno.getAluno(matricula))) {
			return true;
		}
		return alunos.add(repAluno.getAluno(matricula));
	}
